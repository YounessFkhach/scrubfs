...
A single virtual folder that mirrors your folders with metadata stripped on read.
...
scrubfs mounts as one folder containing all your configured folders as
